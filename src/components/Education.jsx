...
const Education = () => {
    return (
        <div data-scroll data-scroll-section data-scroll-speed="-.085" className='w-full bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl gap-6 px-8 py-14 lg:px-16 text-black'>
            <div className='w-full py-2 flex items-center gap-4 justify-start mb-4 lg:mb-8'>
                <h1 className='text-3xl lg:text-6xl font-bold'>Education</h1>
